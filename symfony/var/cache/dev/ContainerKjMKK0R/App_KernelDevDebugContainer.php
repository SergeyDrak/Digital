...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function get_Container_Private_TwigService()
    {
        ...
        $a->addPath((\dirname(__DIR__, 4).'/.bundles/SubscriptionBundle/templates'), 'subscription');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b->addDriver($c, 'Sergeydrak\\SubscriptionBundle\\Entity');

        $a->setEntityNamespaces(['App' => 'App\\Entity', 'SubscriptionBundle' => 'Sergeydrak\\SubscriptionBundle\\Entity']);
