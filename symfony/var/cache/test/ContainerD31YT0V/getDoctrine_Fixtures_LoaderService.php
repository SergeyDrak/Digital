...
class getDoctrine_Fixtures_LoaderService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addFixtures([0 => ['fixture' => ($container->privates['App\\DataFixtures\\CategoryFixtures'] ?? $container->load('getCategoryFixturesService')), 'groups' => []], 1 => ['fixture' => ($container->privates['App\\DataFixtures\\UserFixtures'] ?? $container->load('getUserFixturesService')), 'groups' => []]]);
